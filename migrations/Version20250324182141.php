 ...
 */
final class Version20250324182141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, age INT NOT NULL, status VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, telegram VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, icon VARCHAR(255) NOT NULL, department_id INT NOT NULL, INDEX IDX_8D93D649AE80F5DF (department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
